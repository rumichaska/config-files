...
function test-fonts() {
  ...
  print-unicode-ranges e0a3 e0a3 e0b4 e0c8 e0ca e0ca e0cc e0d4
  echo; echo

  echo "Nerd Fonts - Symbols original"
  # print-unicode-ranges e5fa e62b
  print-unicode-ranges e5fa e6ac
  echo; echo
  ...
  print-unicode-ranges f400 f532 2665 2665 26A1 26A1
  echo; echo
  ...
  # print-unicode-ranges f0001 f0010 f0055 f0055 f0100 f02ff f1440 f144f
  print-unicode-ranges f0001 f1af0
  echo; echo

  echo "Nerd Fonts - Weather Icons"
  # print-unicode-ranges e300 e3eb
  print-unicode-ranges e300 e3e3
  echo; echo
  ...
  # print-unicode-ranges ea70 eaff eb00 ebe9 e62c e6ad
  # echo; echo
}
